...
model = RandomizedSearchCV(XGBClassifier(), parameters, cv=kFold, verbose=1,) #이건 정말 랜덤으로 한다. 여기서는 50번 했다. Fitting 5 folds for each of 10 candidates, totalling 50 fits
