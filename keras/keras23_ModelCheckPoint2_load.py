#keras23_ModelCheckPoint1.py 을 카피하였다. 
# 이제 EarlyStopping으로 저장한 모델을 로드하자
...
# EarlyStopping까지 걸은 상태에서 거기서 제일 좋은 가중치를 저장하고 그대로 model.load를 통해 불러왔다. 결과값은 보통 같으나, 다른 경우도 있다. 
#rmse = 154.68051147460938 걸린시간 :  293.1762545108795 초
#rmse = 154.68051147460938로 같은 것을 알 수있다. 이건 최적의 가중치까지 저장된, 완벽하게 된 것이다. 그걸 바로 가져다 쓰니까 훈련 시간이 없다시피 하다. 걸린시간 :  0.2406482696533203 초
