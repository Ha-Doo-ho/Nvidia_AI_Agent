...
#지금까지 배운 것들을 모두 적용시켜 보자.
#keras/keras11_2_diabetes.py 적용
...
# train, test로 자른다. 
x_train, x_test,y_train, y_test = train_test_split(x,y,train_size=0.8, random_state=15, shuffle=True)
...
model.fit(x_train, y_train, epochs=100000, batch_size=4, validation_split = 0.3, callbacks=[es])
