...
import pandas as pd
from keras.utils import to_categorical #이건 tensorflow의 방식이다. 텐서플로우의 원 핫 인코딩으로 하려면 to_categorical(y) 하면 된다. 이건 true false가 아닌 조금더 가독성 있는 1,0,0 이렇게 나온다. 
...
######### onehot 02 tensorflow이용 #######
#y = to_categorical(y) 이건 조금 더 가독성 있게 나온다. 
