...
# keras17_softmax_OneHot_iris.py 를 카피하였다.  이제 배운 것을 사용해 보자.
...
exit()
print(x.shape, y.shape) #(178, 13) (150,)
#exit()
print(np.unique(y, return_counts=True)) #(array([0, 1, 2]), array([59, 71, 48])) 이거 보고 다중분류라는 것을 바로 떠올리고 원핫을 해주어야 하겠다, input_shpe=(13,)이고 아웃풋은 3임을 알 수 있다. 그리고 채점하려면 역시 argmax하면 됨.  
